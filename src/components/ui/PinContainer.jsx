    ...
    <a
      ...
      <div
        ...
        <div
          ...
          className="absolute top-1/2  flex justify-start items-start  rounded-3xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full  bg-gray-300 dark:bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
            <span
              className="relative z-20 text-zinc-950 dark:text-white  text-xs font-bold inline-block py-0.5">
              {/* {title} */}
              LinkedIn
            </span>
