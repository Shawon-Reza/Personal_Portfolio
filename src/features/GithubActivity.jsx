...
const GithubActivity = () => {
  ...
  const { data: stats, isLoading: loading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch('https://streak-stats.demolab.com/?user=shawon-reza&type=json')
  ...
  return (
    <section className={`relative py-16 sm:py-20 transition-colors duration-500 ${
      ...
      <div className="relative mx-auto  px-6">
        ...
        >
          ...
          <motion.div
            ...
            className={`relative overflow-hidden rounded-2xl border px-4 sm:px-6 py-6 sm:py-8 shadow-lg transition-colors duration-300 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <motion.div
              variants={itemVariants}
              className={`relative overflow-hidden rounded-2xl border px-6 py-8 shadow-lg transition-all duration-300 ${
                darkMode ? 'border-slate-800/80 bg-slate-900/60' : 'border-slate-200/80 bg-white/80'
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={`inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 ${
                darkMode
